export type EAppsmithWidgetType = 'CANVAS_WIDGET' | 'TEXT_WIDGET' | 'INPUT_WIDGET_V2';
export type EAppsmithHeight = 'FIXED' | 'AUTO_HEIGHT' | 'AUTO_HEIGHT_WITH_LIMITS';
export type EAppsmithTextAlign = 'LEFT' | 'RIGHT' | 'CENTER';
export type EAppsmithOverflow = 'SCROLL' | 'NONE' | 'TRUNCATE';
export type EAppsmithInputType = 'TEXT' | 'MULTI_LINE_TEXT' | 'PASSWORD' | 'EMAIL' | 'NUMBER';
...
export type EAppsmithTreeSelectDyBindingPath = 'borderRadius' | 'accentColor' | 'options';
export type EAppsmithTreeSelectDyPropertyPath =
  ...
  | 'borderRadius'
  | 'boxShadow';
export type EAppsmithTreeSelectDyTriggerPath = 'onOptionChange' | 'onDropdownOpen' | 'onDropdownClose';
...
export type EAppsmithIframeDyPropertyPath =
  ...
  | 'borderRadius'
  | 'boxShadow';
export type EAppsmithIframeDyTriggerPath = 'onURLChanged' | 'onMessageReceived' | 'onSrcDocChanged';
